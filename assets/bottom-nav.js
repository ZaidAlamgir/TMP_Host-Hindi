    ...
    function initHomepageArticles(homeGrid) {
        ...
        function renderArticles(articlesToRender) {
            if (!articlesToRender || articlesToRender.length === 0) {
                homeGrid.innerHTML = '<p style="text-align:center;color:#606770;grid-column:1/-1;padding:2rem;">इस श्रेणी में कोई समाचार उपलब्ध नहीं है।</p>';
                return;
            }
            ...
            homeGrid.innerHTML = limit.map(post => {
                ...
                const subheadline = post.subheadline || 'पूरा समाचार पढ़ने के लिए क्लिक करें।';
                let formattedDate = '';
                if (post.date) {
                    const d = new Date(post.date);
                    const options = { month: 'long', day: 'numeric', year: 'numeric' };
                    formattedDate = d.toLocaleDateString('hi-IN', options);
                }
                return `
                <a href="${post.url}" class="news-card fade-in">
                    ...
                    <div class="news-card-text">
                        ...
                        <span class="read-more-text" style="font-size:0.85rem;font-weight:800;color:#0073e6;text-transform:uppercase;margin-top:auto;">आगे पढ़ें &#8594;</span>
                    </div>
                </a>`;
            }).join('');
        }
